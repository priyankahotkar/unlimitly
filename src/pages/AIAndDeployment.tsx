...
import { ExternalLink, ArrowUpRight, Laptop, Terminal, Github, Zap, Code, Download, MonitorSmartphone } from "lucide-react";
...
export default function AIAndDeployment() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-white py-10 px-2 md:px-0 font-sans">
